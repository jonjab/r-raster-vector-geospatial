...
rgb_allcropped_sjer <-  list.files("data/NEON-DS-Landsat-NDVI/SJER/2011/RGB/",
                              full.names=TRUE,
                              pattern = ".tif$")
# create a layout
par(mfrow = c(5, 4))
...
for (aFile in rgb_allcropped_sjer)
  {ndvi_raststack <- rast(aFile)
  if (aFile =="data/NEON-DS-Landsat-NDVI/SJER/2011/RGB//254_SJER_landRGB.tif")
    {plotRGB(ndvi_raststack) }
  else { plotRGB(ndvi_raststack, stretch="lin") }
}
