...
chm_harv_sp <- vect(chm_harv_df, coords = c("x", "y"), crs = utm_18n_crs)
...
# create chm_crop_p_harv as a vector layer
chm_crop_p_harv_sp <- vect(chm_crop_p_harv_df, coords = c("x", "y"),
                                  crs = utm_18n_crs)
# approximate the boundary box with random sample of raster points
chm_crop_p_harv_sp_rand_sample = sample_n(chm_crop_p_harv_sp, 10000)
```
