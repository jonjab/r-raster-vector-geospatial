...
In Episodes 01-05, we worked with vector data representing discrete features (points,
lines, polygons). Now we'll learn about raster data, which represents continuous surfaces
as a grid of cells (pixels), each with a value. Raster data is commonly used for satellite
imagery, elevation models, and climate data.
...
``` output
 ...
 [2] "Files: /__w/r-raster-vector-geospatial/r-raster-vector-geospatial/site/built/data/NEON-DS-Airborne-Remote-Sensing/HARV/DSM/HARV_dsmCrop.tif"                                                                                                                                    
 [3] "Size is 1697, 1367"                                                                                                                                                                                                                                                             
...
We can use `ggplot()` to plot this data using the `tidyterra` package, which
allows us to plot raster data directly without converting to a dataframe. We
will set the color scale to `scale_fill_viridis_c` which is a color-blindness
friendly color scale. We will also use the `coord_sf()` function to handle the
...
<img src="fig/06-raster-structure-rendered-ggplot-raster-1.png" alt="Raster plot with ggplot2 using the viridis color scale"  />
...
<img src="fig/06-raster-structure-rendered-unnamed-chunk-5-1.png" alt="" style="display: block; margin: auto;" />
...
[Work with Multi-band Rasters in R](https://datacarpentry.org/r-raster-vector-geospatial/10-raster-multi-band-in-r).
...
<img src="fig/06-raster-structure-rendered-demonstrate-no-data-black-ggplot-1.png" alt="" style="display: block; margin: auto;" />
...
<img src="fig/06-raster-structure-rendered-demonstrate-no-data-ggplot-1.png" alt="" style="display: block; margin: auto;" />
...
<img src="fig/06-raster-structure-rendered-unnamed-chunk-7-1.png" alt="" style="display: block; margin: auto;" />
...
<img src="fig/06-raster-structure-rendered-demo-bad-data-highlighting-1.png" alt="" style="display: block; margin: auto;" />
...
``` r
ggplot() +
    geom_histogram(data = dsm_harv, aes(x = HARV_dsmCrop))
```
...
<img src="fig/06-raster-structure-rendered-view-raster-histogram-1.png" alt="" style="display: block; margin: auto;" />
...
``` r
ggplot() +
    geom_histogram(data = dsm_harv, aes(x = HARV_dsmCrop), bins = 40)
```

<img src="fig/06-raster-structure-rendered-view-raster-histogram2-1.png" alt="" style="display: block; margin: auto;" />
...
Notice: this file is a hillshade. We will learn about hillshades in the [Working with Multi-band Rasters in R](https://datacarpentry.org/r-raster-vector-geospatial/10-raster-multi-band-in-r) episode.
...
``` output
 [1] "Driver: GTiff/GeoTIFF"                                                                                                                                                                                                                                                          
 [2] "Files: /__w/r-raster-vector-geospatial/r-raster-vector-geospatial/site/built/data/NEON-DS-Airborne-Remote-Sensing/HARV/DSM/HARV_DSMhill.tif"                                                                                                                                    
 [3] "Size is 1697, 1367"                                                                                                                                                                                                                                                             
 [4] "Coordinate System is:"                                                                                                                                                                                                                                                          
 [5] "PROJCRS[\"WGS 84 / UTM zone 18N\","                                                                                                                                                                                                                                             
 [6] "    BASEGEOGCRS[\"WGS 84\","                                                                                                                                                                                                                                                    
