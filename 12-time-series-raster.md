...
[Work with Multi-band Rasters in R](https://datacarpentry.org/r-raster-vector-geospatial/10-raster-multi-band-in-r) episode.
...
[an earlier episode](10-raster-multi-band-in-r/).
